        ...
        <div className="flex flex-col gap-12">
          ...
          <section className="text-center">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We&apos;re dedicated to providing accurate lyrics to music lovers
              around the world
            </p>
          </section>
          ...
          <section className="grid gap-6 md:grid-cols-2 md:gap-12 items-center">
            <div>
              ...
              <div className="space-y-4 text-muted-foreground">
                <p>
                  Founded in 2023, LyricsFinder began with a simple idea: to
                  create a platform where music lovers could easily find
                  accurate lyrics to their favorite songs.
                </p>
                <p>
                  What started as a small project by a group of music
                  enthusiasts has grown into a comprehensive database of lyrics
                  from artists around the world.
                </p>
                <p>
                  Today, we&apos;re proud to offer one of the largest
                  collections of verified lyrics, helping music fans connect
                  more deeply with the songs they love.
                </p>
              </div>
            </div>
          ...
          <section className="bg-muted rounded-lg p-8 md:p-12">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl mb-6">
                To help music lovers understand and connect with their favorite
                songs through accurate lyrics.
              </p>
              <div className="grid gap-6 sm:grid-cols-3">
                <div className="flex flex-col items-center p-4">
                  ...
                  <p className="text-sm text-muted-foreground text-center">
                    Providing verified and correct lyrics
                  </p>
                </div>
                <div className="flex flex-col items-center p-4">
                  <div className="rounded-full bg-primary/10 p-3 mb-3">
                  ...
                  <p className="text-sm text-muted-foreground text-center">
                    Making lyrics available to everyone
                  </p>
                </div>
                <div className="flex flex-col items-center p-4">
                  <div className="rounded-full bg-primary/10 p-3 mb-3">
          ...
          <section className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Have suggestions for improving our lyrics database? We&apos;d love
              to hear from you!
            </p>
